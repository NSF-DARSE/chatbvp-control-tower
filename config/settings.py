...
#give your own DB credentials here or set them as environment variables
DATABASES = {
    "default": {
        "ENGINE": "django.db.backends.postgresql",
        "NAME": os.getenv("DB_NAME", "controltower_db"),
        "USER": os.getenv("DB_USER", "controltower_user"),
        "PASSWORD": os.getenv("DB_PASSWORD", "Aa9886603727$"),
...
MATRIX_FAILURE_RATE = 1.0  # 20% fail we can change later based on BSP Requirements
...
MATRIX_WEB_URL = os.getenv("MATRIX_WEB_URL", "")
